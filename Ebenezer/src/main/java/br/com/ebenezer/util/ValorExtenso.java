...
public class ValorExtenso implements Serializable {
	private static final long serialVersionUID = -1369137519797480072L;
	...
	public String write(final BigDecimal amount) {
		...
		/*
		 * TODO substituir o método setScale, abaixo, pela versão cujo parâmetro de
		 * arredondamento é um enum
		 */
		...
		while (!decomposed.empty()) {
			...
			switch (expoente) { // TODO ao invés desses switches e ifs, partir para a idéia das "Pendências";
